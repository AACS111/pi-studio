...
Pi Studio's interface uses a small internal i18n layer. It is intentionally kept
...
/** Pi Studio Japanese language package. */
...
Pi Studio is a user-facing web interface. Internationalization is therefore an
...
support should lower the barrier to using Pi Studio, not be treated as a measure
