...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "browser.consoleStatus": "Agent-controlled browser (browser-use):",
    ...
    "browser.consoleNotRunning": "Agent browser offline — start the browser-use sidecar (tools/browser-use-server/start.bat) so the agent can drive it.",
  },
};
