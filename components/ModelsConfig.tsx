    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      <div style={{ borderTop: "1px solid var(--border)", paddingTop: 14, display: "flex", flexDirection: "column", gap: 10 }}>
        ...
        {discoveryState.phase === "error" && (
          <div style={{ padding: "7px 9px", border: "1px solid rgba(239,68,68,0.3)", borderRadius: "var(--radius-xs)", color: "#ef4444", fontSize: 11, lineHeight: 1.4 }}>
        ...
        {discoveryState.phase === "success" && (
          <>
            ...
            <div style={{ maxHeight: 220, overflowY: "auto", border: "1px solid var(--border)", borderRadius: "var(--radius-xs)", background: "var(--bg-panel)" }}>
              <label
                style={{
      ...
      <div style={{ display: "flex", gap: 8 }}>
        {isWorking ? (
          ...
          <>
            <button
              onClick={handleLogin}
              style={{ padding: "5px 14px", background: "var(--accent)", border: "none", borderRadius: "var(--radius-xs)", color: "#fff", cursor: "pointer", fontSize: 12, fontWeight: 600 }}
            >
            ...
            {provider.loggedIn && (
              <button
                ...
                style={{ padding: "5px 12px", background: "none", border: "1px solid rgba(239,68,68,0.3)", borderRadius: "var(--radius-xs)", color: "#ef4444", cursor: "pointer", fontSize: 12 }}
              >
                 {t("i18n.disconnect")}
              </button>
            )}
      ...
      {provider.configured && (
        <button
          ...
          style={{
            ...
            borderRadius: "var(--radius-xs)", color: "#ef4444",
...
function AddProviderPicker({
  ...
  return (
    ...
    >
      <div style={{ width: 820, maxWidth: "calc(100vw - 32px)", maxHeight: "min(72vh, calc(100vh - 32px))", background: "var(--bg-elevated)", border: "1px solid var(--border)", borderRadius: "var(--radius-md)", display: "flex", flexDirection: "column", boxShadow: "var(--shadow-lg)", overflow: "hidden" }}>
        {/* Search */}
...
export function ModelsConfig({ onClose }: { onClose: () => void }) {
  ...
  return (
    ...
    <div style={{ position: "fixed", inset: 0, zIndex: 1000, background: "rgba(0,0,0,0.35)", display: "flex", alignItems: "center", justifyContent: "center" }}
      onClick={(e) => { if (e.target === e.currentTarget) onClose(); }}>
      <div style={{ width: isMobile ? "calc(100vw - 16px)" : 860, maxWidth: "calc(100vw - 16px)", height: isMobile ? "calc(100dvh - 16px)" : "78vh", maxHeight: "calc(100dvh - 16px)", background: "var(--bg-elevated)", border: "1px solid var(--border)", borderRadius: "var(--radius-md)", display: "flex", flexDirection: "column", boxShadow: "var(--shadow-lg)", overflow: "hidden" }}>
          ...
          <div style={{
              ...
              {activeOAuth.map((p) => {
                ...
                return (
                  <div
                    ...
                    style={{ display: "flex", alignItems: "center", gap: 7, padding: "5px 8px", borderRadius: "var(--radius-xs)", cursor: "pointer", background: isSelected ? "var(--bg-selected)" : "none" }}
                ...
                return (
                  <div key={pName} style={{ marginBottom: 2 }}>
                    ...
                    <div
                      ...
                      style={{ display: "flex", alignItems: "center", gap: 6, padding: "7px 8px", borderRadius: "var(--radius-xs)", cursor: "pointer", background: isProviderSelected ? "var(--bg-selected)" : "none" }}
                    ...
                    {models.map((m, i) => {
                      ...
                      return (
                        <div
                          ...
                          style={{ display: "flex", alignItems: "center", gap: 6, padding: "5px 8px 5px 26px", borderRadius: "var(--radius-xs)", cursor: "pointer", background: isModelSelected ? "var(--bg-selected)" : "none" }}
                    ...
                    <div
                      ...
                      style={{ display: "flex", alignItems: "center", gap: 4, padding: "4px 8px 4px 26px", borderRadius: "var(--radius-xs)", cursor: "pointer", color: "var(--text-dim)" }}
            ...
            <div style={{ borderTop: "1px solid var(--border)", padding: "8px 6px" }}>
              <button onClick={() => setPickerOpen(true)} style={{
                ...
                width: "100%", padding: "6px 0", background: "none", border: "1px dashed var(--border)", borderRadius: "var(--radius-xs)",
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "flex-end", gap: 10, padding: "10px 18px", borderTop: "1px solid var(--border)", flexShrink: 0 }}>
          ...
          <button onClick={onClose} style={{ padding: "6px 14px", background: "none", border: "1px solid var(--border)", borderRadius: "var(--radius-xs)", color: "var(--text-muted)", cursor: "pointer", fontSize: 13 }}>
             {t("i18n.cancel")}
          </button>
